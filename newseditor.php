...
if (isset($_SESSION['userid']) && ($user->role) == 'basic') {
...
?>
<div class="jumbotron">
    <h1 class="display-5">News Editor <?php if (!empty($newsedit['news_id'])) { ?><h4><a class="badge badge-warning"
  ...
  <strong>Error: </strong> ' . $admin_error_message . '</div>';
    ...
    <form action="newseditor.php" method="post" name="editnews">
        <div class="card border-primary mb-3">
            ...
            <div class="card-body">
                <input type="text" class="form-control" name="newsid" id="newsidf" placeholder="ID"
        ...
        <div class="card border-primary mb-3">
            ...
            <div class="card-body">
                <input type="text" class="form-control" name="title" id="titlef"
                       ...
                       } ?>" required="required" pattern="[\s\S]*\S[\s\S]*" minlength="2" maxlength="150"/>
            </div>
        </div>
        <div class="card border-primary mb-3">
            <div class="card-header"><h4>Author</h4></div>
            <div class="card-body">
                <input type="text" class="form-control" name="author" id="authorf" placeholder="Author's name"
        ...
        <div class="card border-primary mb-3">
            ...
            <div class="card-body">
                <input type="text" class="form-control" name="publish" id="publishf" placeholder="Publishing date"
        ...
        <?php if ($updating) { ?>
            <button type="submit" class="btn btn-info btn-lg" name="btnUpdateNews">Update <i class="fa fa-pencil"></i>
            </button>
            <button type="submit" name="btnDeleteNews" onClick='return confirmSubmit()' class="btn btn-danger btn-lg">
